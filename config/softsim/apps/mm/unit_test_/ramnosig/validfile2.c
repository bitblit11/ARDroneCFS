/************************************************************************
** File:
**   $Id: validfile2.c 1.2 2015/03/01 17:17:39EST sstrege Exp  $
**
...
**
** $Log: validfile2.c  $
** Revision 1.2 2015/03/01 17:17:39EST sstrege 
** Added copyright information
** Revision 1.1 2012/01/09 19:26:30EST aschoeni 
** Initial revision
** Member added to project c:/MKSDATA/MKS-REPOSITORY/CFS-REPOSITORY/md/fsw/unit_test/ramnosig/project.pj
** Revision 1.1 2009/10/09 17:14:52EDT aschoeni 
** Initial revision
...
static CFE_TBL_FileDef_t CFE_TBL_FileDef =
{
    ...
    "validfile2.tbl", MD_TBL_LOAD_LNGTH
};
