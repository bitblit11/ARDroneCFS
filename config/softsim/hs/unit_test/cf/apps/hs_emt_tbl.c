/************************************************************************
** File:
**   $Id: hs_emt_tbl.c 1.2 2015/03/03 12:16:25EST sstrege Exp  $
**
...
**
** $Log: hs_emt_tbl.c  $
** Revision 1.2 2015/03/03 12:16:25EST sstrege 
** Added copyright information
** Revision 1.1 2010/11/17 17:01:36EST aschoeni 
** Initial revision
** Member added to project c:/MKSDATA/MKS-REPOSITORY/CFS-REPOSITORY/hs/fsw/unit_test/cf/apps/project.pj
** Revision 1.1 2009/05/22 17:54:13EDT aschoeni 
** Initial revision
...
/*   0 */ { "TASK_1",                  0,       2,             HS_EMT_ACT_MSG(0) },
/*   1 */ { "TASK_2",                  0,       5,             HS_EMT_ACT_APP_RESTART },
/*   2 */ { "TASK_3",                  0,       10,            HS_EMT_ACT_PROC_RESET },
/*   3 */ { "TASK_4",                  0,       10,            HS_EMT_ACT_APP_DELETE },
/*   4 */ { "TASK_1",                  0,       20,            HS_EMT_ACT_MSG(1) },
/*   5 */ { "TASK_5",                  0,       20,            HS_EMT_ACT_MSG(1) },
/*   6 */ { "TASK_5",                  0,       6,             HS_EMT_ACT_APP_RESTART },
/*   7 */ { "TASK_5",                  0,       7,             HS_EMT_ACT_APP_DELETE },
