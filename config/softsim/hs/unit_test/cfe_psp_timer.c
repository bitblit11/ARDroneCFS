...
typedef struct
{
  uint32   UtilMult1;/**< \brief CPU Utilization Conversion Factor Multiplication 1 */
  uint32   UtilDiv;/**< \brief CPU Utilization Conversion Factor Division */
  uint32   UtilMult2;/**< \brief CPU Utilization Conversion Factor Multiplication 2 */
