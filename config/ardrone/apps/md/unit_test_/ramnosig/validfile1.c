/************************************************************************
** File:
**   $Id: validfile1.c 1.2 2015/03/01 17:17:45EST sstrege Exp  $
**
...
**
** $Log: validfile1.c  $
** Revision 1.2 2015/03/01 17:17:45EST sstrege 
...
** Revision 1.1 2009/10/09 17:14:51EDT aschoeni 
** Initial revision
...
static CFE_TBL_FileDef_t CFE_TBL_FileDef =
{
    ...
    "validfile1.tbl", MD_TBL_LOAD_LNGTH
};
