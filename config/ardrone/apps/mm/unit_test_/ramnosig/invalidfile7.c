/************************************************************************
** File:
**   $Id: invalidfile7.c 1.2 2015/03/01 17:17:43EST sstrege Exp  $
**
...
**
** $Log: invalidfile7.c  $
** Revision 1.2 2015/03/01 17:17:43EST sstrege 
** Added copyright information
** Revision 1.1 2012/01/09 19:26:23EST aschoeni 
** Initial revision
...
static CFE_TBL_FileDef_t CFE_TBL_FileDef =
{
    ...
    "invalidfile7.tbl", MD_TBL_LOAD_LNGTH
};
